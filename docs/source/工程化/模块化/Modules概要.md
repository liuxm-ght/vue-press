...
## 概要
  1. 什么事模块？
      ...
      ::: warning 两个基本的特征：外部特征和内部特征
      外部特征是指模块跟外部环境联系的接口（即其他模块或程序调用该模块的方式，包括有输入输出参数、引用的全局变量）和模块的功能

      内部特征是指模块的内部环境具有的特点（即该模块的局部数据和程序代码）
      :::

  2. 模块化的优势[链接：](https://juejin.cn/post/6844903792987602958)
      1. 方便维护代码，更好的分离，按需加载
      2. 提高代码复用性
      3. 降低代码耦合度（降偶）
  ...
  3. [模块化进程](https://juejin.cn/post/6844904056847073293#heading-6  )
      * 了解模块化进程的好处是，可以更深入理解为何需要现代化的模块化，同时可以了解各类型模块化的优劣。
      ...
      4. [CommonJs](./Modules/CJS/CommonJS.md)
          * 实现：
...
## 前端模块化 类别
  ### 1. [IIFE](./Modules/IIFE/IIFE.md)
  ### 2. [CommonJs](./Modules/CJS/CommonJS.md)
  ### 3. [AMD](./Modules/AMD/AMD.md)
  ### 4. [CMD](./Modules/CMD/CMD.md)
  ### 5. [ES6](./Modules/ESM/ES6.md)
